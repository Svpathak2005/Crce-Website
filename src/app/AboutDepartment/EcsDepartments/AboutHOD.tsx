      ...
      <div className="mt-8 rounded-lg bg-white p-6 shadow-md">
        ...
        <div className="text-justify">
          <p className="mb-4 text-gray-700 leading-relaxed">
            Dear Students, Lorem ipsum dolor sit amet consectetur adipisicing elit. Totam nam dolor eveniet aperiam error eius placeat, praesentium ex deserunt ad odio nisi quod consequuntur, nobis architecto a eligendi ut quaerat!
          </p>
