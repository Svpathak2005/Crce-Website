...
export const Vision = {
  name: 'Vision',
  description:
    'To mould high-quality, innovative, and ethical engineers to become part of the global workforce and contribute to the betterment of society.',
  video: false,
}
...
export const ProgramEducationalObjectives = {
  ...
  description:
    'Innovate, create, analyze, design, implement and test AI-based solutions to solve real-world business problems. Adapt to changing AI-DS technology and use it in a multidisciplinary context. Adapt to changing AI-DS technology and use it in a multidisciplinary context.',
  video: false,
}
...
export const programs = [
  {
    ...
    description: [
      'Undergrad program in Computer Scrience and Engineering.',
      'Duration: 4 years ',
      'Intake: 180 students ',
  ...
  },
  {
    ...
    description: [
      'Postgrad program in Computer Scrience and Engineering',
      'Duration: 2 years',
      'Intake: 60 students',
      'Eligibility: B.Tech in Computer Scrience and Engineering',
    ],
    icon: (
      <svg
        fill="none"
  ...
  },
  {
    title: 'PhD Programs',
    description: [
      'Doctoral programs in Computer Scrience and Engineering',
      'Duration : 3 years',
      'Intake: 10 students',
      'Eligibility: M.Tech in Computer Scrience and Engineering',
    ],
    icon: (
      <svg
        fill="none"
