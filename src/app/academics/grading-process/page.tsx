    ...
    <div className="min-h-screen bg-gray-100 p-8">
      <div className="mx-auto max-w-4xl overflow-hidden rounded-lg bg-white shadow-lg">
        ...
        <main className="p-6">
          ...
          <section className="mb-8">
            <h4 className="mb-4 text-2xl font-semibold">Attendance</h4>
            <p>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              <strong>B.E. Project:</strong> Project-I and Project-II are
            ...
            <p className="mb-4">
              <strong>M.E. Dissertation:</strong> For evaluation of
          ...
          {/* Add more sections for SGPI/CGPI Calculation, Heads of Passing, Promotion of Learner, etc. */}
        </main>
      </div>
    </div>
  )
