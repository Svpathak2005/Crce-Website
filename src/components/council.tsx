...
export default function Council() {
  ...
  const cards = [
    ...
    },
    {
      ...
      instagram: "https://www.instagram.com/codelabscrce/",
      linkedin: "https://www.linkedin.com/company/mozilla-campus-club-crce?originalSubdomain=in",
              ...
              >
                ...
                >
                  ...
                  <div className="mt-4 flex justify-center space-x-4">
                    {card.website && <a href={card.website} target="_blank" rel="noopener noreferrer"><Earth className="text-2xl text-blue-600" /></a>}
                    {card.youtube && <a href={card.youtube} target="_blank" rel="noopener noreferrer"><Youtube className="text-2xl text-red-600" /></a>}
                    {card.linkedin && <a href={card.linkedin} target="_blank" rel="noopener noreferrer"><Linkedin className="text-2xl text-blue-400" /></a>}
                    {card.instagram && <a href={card.instagram} target="_blank" rel="noopener noreferrer"><Instagram className="text-2xl text-pink-600" /></a>}
                    {card.facebook && <a href={card.facebook} target="_blank" rel="noopener noreferrer"><Facebook className="text-2xl text-blue-600" /></a>}
                  </div>
                </div>
              </div>
            </div>
