    ...
    <section className="hero body-font relative mt-[-160px] min-h-screen w-full text-gray-600">
      ...
      <div className="container mx-auto flex h-full items-center justify-center px-5">
        <div className="relative z-10 mt-40 flex h-fit w-full flex-col rounded-lg bg-white bg-opacity-85 p-8 shadow-md md:ml-auto md:mt-0 md:w-1/2 lg:w-1/3">
          <h2 className="title-font mb-1 md:text-5xl text-3xl font-medium leading-tight text-gray-900">
          ...
          <button className="w-fit rounded-md border-0 bg-yellow-500 px-6 py-2 text-lg text-gray-950 hover:bg-yellow-600 focus:outline-none">
            Get Started
          </button>
        </div>
      </div>
